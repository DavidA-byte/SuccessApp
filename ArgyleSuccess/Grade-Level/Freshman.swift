...
extension NumberFormatter {
    static let decimal_Freshman: NumberFormatter = {
...
struct ClassDetailSubview_Freshman : View {
...
struct UnweightedGradeView_Freshman : View {
...
struct WeightedGradeView_Freshman : View {
...
struct CategoryView_Freshman: View {
...
// Sample data
let courseLevels_Freshman  = ["Select", "Honors", "AP", "Dual Credit", "On-Level"]
let subjects_Freshman  = ["Select", "Math", "Science", "English", "History", "UIL"]
