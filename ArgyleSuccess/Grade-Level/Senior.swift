...
extension NumberFormatter {
    static let decimal_Senior: NumberFormatter = {
...
struct ClassDetailSubview_Senior: View {
...
struct UnweightedGradeView_Senior: View {
...
struct WeightedGradeView_Senior: View {
...
struct CategoryView_Senior: View {
...
// Sample data
let courseLevels_Senior = ["Select", "Honors", "AP", "Dual Credit", "On-Level"]
let subjects_Senior = ["Select", "Math", "Science", "English", "History", "UIL"]
