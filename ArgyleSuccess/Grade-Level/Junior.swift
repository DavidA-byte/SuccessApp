...
extension NumberFormatter {
    static let decimal_Junior: NumberFormatter = {
...
struct ClassDetailSubview_Junior: View {
...
struct UnweightedGradeView_Junior: View {
...
struct WeightedGradeView_Junior: View {
...
struct CategoryView_Junior: View {
...
// Sample data
let courseLevels_Junior = ["Select", "Honors", "AP", "Dual Credit", "On-Level"]
let subjects_Junior = ["Select", "Math", "Science", "English", "History", "UIL"]
