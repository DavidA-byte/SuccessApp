...
//  ArgyleSuccess
//
//  Created by David Aiyeyemi on 6/17/24.
//

import SwiftUI

extension NumberFormatter {
    static let decimal_Sopmhore: NumberFormatter = {
...
struct ClassDetailSubview_Sophmore: View {
    ...
    private var selectedSubjectKey: String {
        "SelectedSubject\(gradeLevelName)-\(classNumber)"
    }
    
    private var selectedLevelKey: String {
        "SelectedLevel\(gradeLevelName)-\(classNumber)"
    }
    
    private var categoriesKey: String {
        "Categories\(gradeLevelName)-\(classNumber)"
    }
    ...
    var body: some View {
        ScrollView {
            ...
            .onAppear {
                // Load saved data when the view appears
...
struct UnweightedGradeView_Sophmore : View {
...
struct WeightedGradeView_Sophmore : View {
...
struct CategoryView_Sophmore: View {
...
// Sample data
let courseLevels_Sophmore  = ["Select", "Honors", "AP", "Dual Credit", "On-Level"]
let subjects_Sophmore  = ["Select", "Math", "Science", "English", "History", "UIL"]
